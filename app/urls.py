...
urlpatterns = [
    ...
    path('api/specializations/search/', search_specializations),  # GET
    path('api/specializations/<int:specialization_id>/', get_specialization_by_id),  # GET
    path('api/specializations/<int:specialization_id>/image/', get_specialization_image),  # GET
    path('api/specializations/<int:specialization_id>/update/', update_specialization),  # PUT
    path('api/specializations/<int:specialization_id>/update_image/', update_specialization_image),  # PUT
    ...
    path('api/applicants/search/', search_applicants),  # GET
